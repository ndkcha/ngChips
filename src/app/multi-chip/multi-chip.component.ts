 ...
 * }
 * 
 * - you can also implement the infinite scroller for the multi chips component
 * <cob-multi-chips formControlName="chips" scrollPercent="90" (onScroll)="onScroll()" [options]="<an array, changed by a function>" (onQuery)="onQuery($event)" [threshold]="2"></cob-multi-chips>
 * 
 * component file:
 * onQuery($event): void {
 *      this.options = <an array>;
